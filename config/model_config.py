...
def build_args():
    ...
    parser.add_argument("--dataset", type=str, default="DomainNet", help="Office, OfficeHome, VisDA, DomainNet")
    ...
    parser.add_argument("--lam_hier", default=1.0, type=float)
    ...
    parser.add_argument("--clip_r", default=230, type=float)
    ...
    parser.add_argument("--hyperbolic", default=False, type=bool)
    parser.add_argument("--elr", default=False, type=bool)
    parser.add_argument("--hier", default=False, type=bool)
    parser.add_argument("--cluster_loss", default=False, type=bool)
    parser.add_argument("--shrink", default=False, type=bool)
    ...
    if args.dataset == "Office":
        ...
        args.source_data_dir = os.path.join("/data/henao/swang1/data/office", domain_list[args.s_idx])
        args.target_data_dir = os.path.join("/data/henao/swang1/data/office", domain_list[args.t_idx])
        args.target_domain_list = [domain_list[idx] for idx in range(3) if idx != args.s_idx]
        args.target_domain_dir_list = [os.path.join("/hpc/group/carin/sw361/data/office", item) for item in args.target_domain_list]
        ...
        args.source_data_dir = os.path.join("/data/henao/swang1/data/OfficeHome", domain_list[args.s_idx])
        args.target_data_dir = os.path.join("/data/henao/swang1/data/OfficeHome", domain_list[args.t_idx])
        args.target_domain_list = [domain_list[idx] for idx in range(4) if idx != args.s_idx]
        args.target_domain_dir_list = [os.path.join("/data/henao/swang1/data/OfficeHome", item) for item in args.target_domain_list]
        ...
        args.source_data_dir = "/hpc/group/carin/sw361/data/VisDA/train/"
        ...
        args.source_data_dir = os.path.join("/hpc/group/carin/sw361/data/DomainNet", domain_list[args.s_idx])
        args.target_data_dir = os.path.join("/hpc/group/carin/sw361/data/DomainNet", domain_list[args.t_idx])
        args.target_domain_list = [domain_list[idx] for idx in range(3) if idx != args.s_idx]
        args.target_domain_dir_list = [os.path.join("/hpc/group/carin/sw361/data/DomainNet", item) for item in args.target_domain_list]
    ...
    # for ours
    if args.target_private_class_num > 0:
        args.target_private_list = [i for i in range(args.source_class_num, args.source_class_num+args.target_private_class_num)]
        args.target_class_list = args.target_class_list + args.target_private_list
        # args.ori_target_class_list = [i for i in range(args.shared_class_num)] + args.target_private_list
        # args.target_class_list.append(args.source_class_num)

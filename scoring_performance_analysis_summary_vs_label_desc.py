...
# label_desc_df = pd.read_csv(f'label_description.csv')
# label_desc = []
...
# cos_sim_df.to_csv(f"Domain {domain} similarity_score_summary_vs_label_desc.csv", header=False, index=False)

similarity_scores = pd.read_csv(f"Domain {domain} similarity_score_summary_vs_label_desc.csv", header=None, index_col=False).to_numpy()

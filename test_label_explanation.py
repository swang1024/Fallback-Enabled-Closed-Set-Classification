...
# system_promptv11 = "Can you use one sentence to describe the given object?"
...
system_promptv12 = "What are the determining visual features for distinguishing a {} in a photo?​"
...
for idx, class_label in enumerate(class_list):
        ...
        messages=[
            ...
            # },
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": system_promptv12.format(class_label)},
    ...
    data.append([class_label, res])
    df = pd.DataFrame(data, columns=columns)
    df.to_csv(os.path.join("label_visual_features.csv".format(args.t_idx)), index=False)
